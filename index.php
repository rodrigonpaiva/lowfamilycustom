                    ...
                    <div class="swiper-slide ">
                        <div class="hero__slider--items style4 slider4__items--bg1">
                                ...
                                <div class="row">
                                    <div class="col-lg-7 col-md-7">
                                        <div class="slider__content style4">
                                            <span class="slider__subtitle style4">Get up to 50% off Today Only!</span>
                                            <h2 class="slider__maintitle style4 h1">Winter Sale For <span class="text__secondary">Auto Parts</span></h2>
                                            <p class="slider__desc style4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad, </p>
                            ...
                            <div class="hero__slider--layer__style4">
                                <img class="slider__layer--img " src="assets/img/slider/home4-slider1-layer.webp" alt="slider-img">
                            </div> 
                        </div>
                    </div>
                    <div class="swiper-slide ">
                        <div class="hero__slider--items style4 slider4__items--bg1">
                            ...
                            <div class="hero__slider--layer__style4 style__right">
                                <img class="slider__layer--img " src="assets/img/slider/home4-slider2-layer.webp" alt="slider-img">
                            </div> 
                        </div>
                    </div>
                    <div class="swiper-slide ">
                        <div class="hero__slider--items style4 slider4__items--bg1">
                            ...
                            <div class="hero__slider--layer__style4 style__right">
                                <img class="slider__layer--img " src="assets/img/slider/home4-slider3-layer.webp" alt="slider-img">
                            </div> 
                        </div>
                    </div>
                </div>
        ...
        <section class="product__section section--padding  pt-0">
            <div class="container">
                <div class="section__heading section__heading--flex border-bottom d-flex justify-content-between mb-30">
                    <h2 class="section__heading--maintitle">Explore <span>Products</span></h2>
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-8">
                            <div class="banner__area position__relative">
                                <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img banner__max--height4" src="assets/img/banner/banner15.webp" alt="banner-img">
                            ...
                            <div class="deals__product--card">
                                <div class="deals__product--card__thumbnail">
                                    <a class="display-block" href="product-details.html">
                                        <img class="deals__product--card__thumbnail--img" src="assets/img/product/small-product/product10.webp" alt="product-img">
                                    </a>
                                </div>
                                <div class="deals__product--card__content text-center">
                                    <h3 class="deals__product--title"><a href="product-details.html">Zbrake Disc For BMW </a></h3>
                                    ...
                                    <p class="hurryup__text"><span>Hurry Up!</span>  Offer ends in :</p>
                                    <div class="single__product--countdown d-flex justify-content-center" data-countdown="Sep 30, 2023 00:00:00"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row  mb--n30">
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img" src="assets/img/banner/banner16.webp" alt="banner-img">
                    ...
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img" src="assets/img/banner/banner17.webp" alt="banner-img">
                                <div class="banner__content--style4">
                                    <span class="banner__content--style4__subtitle">Starting at <span>$79.9</span></span>
